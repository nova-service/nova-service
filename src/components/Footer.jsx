            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="flex items-center gap-4 sm:gap-8 mb-12 sm:mb-20">
                    ...
                    <div className="flex items-center gap-4">
                        <a href="https://wa.me/491707864074" target="_blank" rel="noopener noreferrer" className="w-10 h-10 sm:w-12 sm:h-12 rounded-full border border-lime-400 flex items-center justify-center text-lime-400 hover:bg-lime-400 hover:text-black transition-all">
